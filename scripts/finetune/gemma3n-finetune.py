...
torch._dynamo.config.accumulated_recompile_limit = 256  # default 64
...
model.save_pretrained("gemma-3n-2B-en-gguf")  # Local saving
tokenizer.save_pretrained("gemma-3n-2B-en-gguf")
# model.push_to_hub("HF_ACCOUNT/gemma-3", token = "...") # Online saving
# tokenizer.push_to_hub("HF_ACCOUNT/gemma-3", token = "...") # Online saving

model.push_to_hub_merged("viveksil/gemma-3N-2B-en-fa", tokenizer)
